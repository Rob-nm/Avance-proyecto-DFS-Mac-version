...
4.  Inicia el servidor:
    ...
    node server.js
    ```
    _Deberás ver el mensaje: "Servidor Luxury corriendo en puerto 4000"._
...
6.  _Verificación:_ Si revisas la base de datos, verás que el stock del producto ha disminuido.
